export const zhHant = {
  ...
  addons: {
    ...
    cards: {
      extraOutfit: {
        name:        '額外服裝包',
        desc:        '新增服裝，沿用既有 LoRA 延伸',
        priceMain:   'NT$ 1,800 / 套',
        priceBonus:  '',
      },
      extraScene: {
        name:        '額外場景包',
        desc:        '新增場景，沿用既有 LoRA 延伸',
        priceMain:   'NT$ 2,400 / 場景',
        priceBonus:  '',
      },
      styleTransfer: {
        name:        '風格遷移試水',
        desc:        '把現有素材轉成新美學',
        priceMain:   'NT$ 2,800 / 風格',
        priceBonus:  '',
      },
      loraRetrain: {
        name:        'LoRA 季度重訓',
        desc:        '用新素材升級 LoRA，維持質感',
        priceMain:   'NT$ 4,800',
        priceBonus:  '',
        tagLabel:    'Pro 包月免費 ⭐',
      },
      ...
      advancedStyle: {
        name:        '進階風格內容',
        desc:        '電影感光影、特殊質感、複雜場景',
        priceMain:   'NT$ 4,800 / 主題',
        priceBonus:  '',
        tagLabel:    '限 Pro 客戶 🔒',
      },
      rush48h: {
