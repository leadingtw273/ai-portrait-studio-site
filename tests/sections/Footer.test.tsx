...
describe('Footer', () => {
  ...
  it('renders logo, tagline, telegram cta, response time, copyright', () => {
    ...
    // logo 與 copyright 兩處都有 "AI 影像工作室"
    expect(screen.getAllByText(/AI 影像工作室/).length).toBeGreaterThanOrEqual(2)
    ...
    expect(container.textContent).toContain('© 2026 AI 影像工作室. All rights reserved.')
  })
